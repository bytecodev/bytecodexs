...
```lua
Key = "sk_bc.xxxxxxxxx" -- put your license key here
loadstring(game:HttpGet("https://raw.githubusercontent.com/bytecodev/CodexAlpha/main/main.lua"))()
```
